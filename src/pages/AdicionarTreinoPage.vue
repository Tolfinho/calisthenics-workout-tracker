    ...
    <div class="container">
      <div class="page-header">
        <div class="page-title">
          ...
          <h3 class="subtitle">
            Registre seu treino de calistenia
          </h3>
        </div>
      </div>
      ...
      <div class="form-container">
        ...
        <textarea
          ...
          v-model="observacao"
          class="input mb-1"
          placeholder="Informe uma observação para o treino (opcional)"
        />
        ...
        <div v-if="exerciciosTreino.length > 0">
          <div
            v-for="(ex, index) in exerciciosTreino"
            :key="index"
            class="card"
          >
            <label class="label">
        ...
        <button
          class="btn btn-primary salvarBtn"
          @click="salvar"
        >
          Salvar Treino
        </button>
...
const exerciciosList = ref([])

const nome = ref('')
const data_hora = ref('')
const duracao = ref(0)
const observacao = ref('')
const exerciciosTreino = ref([])
